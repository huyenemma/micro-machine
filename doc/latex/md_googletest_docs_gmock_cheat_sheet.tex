\hypertarget{md_googletest_docs_gmock_cheat_sheet_autotoc_md112}{}\doxysection{Defining a Mock Class}\label{md_googletest_docs_gmock_cheat_sheet_autotoc_md112}
\hypertarget{md_googletest_docs_gmock_cheat_sheet_MockClass}{}\doxysubsection{Mocking a Normal Class}\label{md_googletest_docs_gmock_cheat_sheet_MockClass}
Given
...
\{\+: .callout .note\} {\bfseries{Note\+:}} A mock object is currently naggy by default. We may make it nice by default in the future.\hypertarget{md_googletest_docs_gmock_cheat_sheet_MockTemplate}{}\doxysubsection{Mocking a Class Template}\label{md_googletest_docs_gmock_cheat_sheet_MockTemplate}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cheat_sheet_autotoc_md113}{}\doxysubsection{Specifying Calling Conventions for Mock Functions}\label{md_googletest_docs_gmock_cheat_sheet_autotoc_md113}
...
where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily $<$objbase.\+h$>$} on Windows.\hypertarget{md_googletest_docs_gmock_cheat_sheet_UsingMocks}{}\doxysection{Using Mocks in Tests}\label{md_googletest_docs_gmock_cheat_sheet_UsingMocks}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cheat_sheet_OnCall}{}\doxysection{Setting Default Actions}\label{md_googletest_docs_gmock_cheat_sheet_OnCall}
...
To customize the default action for a particular method of a specific mock object, use \href{reference/mocking.md\#ON_CALL}{\texttt{ {\ttfamily ON\+\_\+\+CALL}}}. {\ttfamily ON\+\_\+\+CALL} has a similar syntax to {\ttfamily EXPECT\+\_\+\+CALL}, but it is used for setting default behaviors when you do not require that the mock method is called. See \href{gmock_cook_book.md\#UseOnCall}{\texttt{ Knowing When to Expect}} for a more detailed discussion.\hypertarget{md_googletest_docs_gmock_cheat_sheet_ExpectCall}{}\doxysection{Setting Expectations}\label{md_googletest_docs_gmock_cheat_sheet_ExpectCall}
See \href{reference/mocking.md\#EXPECT_CALL}{\texttt{ {\ttfamily EXPECT\+\_\+\+CALL}}} in the Mocking Reference.\hypertarget{md_googletest_docs_gmock_cheat_sheet_MatcherList}{}\doxysection{Matchers}\label{md_googletest_docs_gmock_cheat_sheet_MatcherList}
See the \mbox{\hyperlink{md_googletest_docs_reference_matchers}{Matchers Reference}}.\hypertarget{md_googletest_docs_gmock_cheat_sheet_ActionList}{}\doxysection{Actions}\label{md_googletest_docs_gmock_cheat_sheet_ActionList}
See the \mbox{\hyperlink{md_googletest_docs_reference_actions}{Actions Reference}}.\hypertarget{md_googletest_docs_gmock_cheat_sheet_CardinalityList}{}\doxysection{Cardinalities}\label{md_googletest_docs_gmock_cheat_sheet_CardinalityList}
See the \href{reference/mocking.md\#EXPECT_CALL.Times}{\texttt{ {\ttfamily Times} clause}} of {\ttfamily EXPECT\+\_\+\+CALL} in the Mocking Reference.\hypertarget{md_googletest_docs_gmock_cheat_sheet_autotoc_md114}{}\doxysection{Expectation Order}\label{md_googletest_docs_gmock_cheat_sheet_autotoc_md114}
By default, expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, you can use the \href{reference/mocking.md\#EXPECT_CALL.After}{\texttt{ {\ttfamily After} clause}} or \href{reference/mocking.md\#EXPECT_CALL.InSequence}{\texttt{ {\ttfamily In\+Sequence} clause}} of {\ttfamily EXPECT\+\_\+\+CALL}, or use an \href{reference/mocking.md\#InSequence}{\texttt{ {\ttfamily In\+Sequence} object}}.\hypertarget{md_googletest_docs_gmock_cheat_sheet_autotoc_md115}{}\doxysection{Verifying and Resetting a Mock}\label{md_googletest_docs_gmock_cheat_sheet_autotoc_md115}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cheat_sheet_autotoc_md116}{}\doxysection{Mock Classes}\label{md_googletest_docs_gmock_cheat_sheet_autotoc_md116}
...
See this \href{gmock_cook_book.md\#UsingCheckPoints}{\texttt{ recipe}} for one application of it.\hypertarget{md_googletest_docs_gmock_cheat_sheet_autotoc_md117}{}\doxysection{Flags}\label{md_googletest_docs_gmock_cheat_sheet_autotoc_md117}
\tabulinesep=1mm

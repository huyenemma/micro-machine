...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_actions_autotoc_md242}{}\doxysection{Side Effects}\label{md_googletest_docs_reference_actions_autotoc_md242}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_actions_autotoc_md243}{}\doxysection{Using a Function, Functor, or Lambda as an Action}\label{md_googletest_docs_reference_actions_autotoc_md243}
...
\DoxyCodeLine{...}
\DoxyCodeLine{InvokeArgument<2>(5, \mbox{\hyperlink{namespacedetail_a917c3efabea8a20dc72d9ae2c673d632ab45cffe084dd3d20d928bee85e7b0f21}{string}}(\textcolor{stringliteral}{"{}Hi"{}}), std::ref(foo))}

\end{DoxyCode}


calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_googletest_docs_reference_actions_autotoc_md244}{}\doxysection{Default Action}\label{md_googletest_docs_reference_actions_autotoc_md244}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_googletest_docs_reference_actions_autotoc_md245}{}\doxysection{Composite Actions}\label{md_googletest_docs_reference_actions_autotoc_md245}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_actions_autotoc_md246}{}\doxysection{Defining Actions}\label{md_googletest_docs_reference_actions_autotoc_md246}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline

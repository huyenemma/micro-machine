You can find recipes for using g\+Mock here. If you haven\textquotesingle{}t yet, please read \mbox{\hyperlink{md_googletest_docs_gmock_for_dummies}{the dummy guide}} first to make sure you understand the basics.

\{\+: .callout .note\} {\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md119}{}\doxysection{Creating Mock Classes}\label{md_googletest_docs_gmock_cook_book_autotoc_md119}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md120}{}\doxysubsection{Dealing with unprotected commas}\label{md_googletest_docs_gmock_cook_book_autotoc_md120}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md121}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_googletest_docs_gmock_cook_book_autotoc_md121}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md122}{}\doxysubsection{Mocking Overloaded Methods}\label{md_googletest_docs_gmock_cook_book_autotoc_md122}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md123}{}\doxysubsection{Mocking Class Templates}\label{md_googletest_docs_gmock_cook_book_autotoc_md123}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_MockingNonVirtualMethods}{}\doxysubsection{Mocking Non-\/virtual Methods}\label{md_googletest_docs_gmock_cook_book_MockingNonVirtualMethods}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md124}{}\doxysubsection{Mocking Free Functions}\label{md_googletest_docs_gmock_cook_book_autotoc_md124}
...
Alternatively, instead of introducing a new interface, you can rewrite your code to accept a std\+::function instead of the free function, and then use \href{\#MockFunction}{\texttt{ Mock\+Function}} to mock the std\+::function.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md125}{}\doxysubsection{Old-\/\+Style $<$tt$>$\+MOCK\+\_\+\+METHODn$<$/tt$>$ Macros}\label{md_googletest_docs_gmock_cook_book_autotoc_md125}
...
\end{longtabu}
\hypertarget{md_googletest_docs_gmock_cook_book_NiceStrictNaggy}{}\doxysubsection{The Nice, the Strict, and the Naggy}\label{md_googletest_docs_gmock_cook_book_NiceStrictNaggy}
If a mock method has no {\ttfamily EXPECT\+\_\+\+CALL} spec but is called, we say that it\textquotesingle{}s an \char`\"{}uninteresting call\char`\"{}, and the default action (which can be specified using {\ttfamily ON\+\_\+\+CALL()}) of the method will be taken. Currently, an uninteresting call will also by default cause g\+Mock to print a warning.
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md126}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_googletest_docs_gmock_cook_book_autotoc_md126}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_googletest_docs_gmock_cook_book_DelegatingToFake}{}\doxysubsection{Delegating Calls to a Fake}\label{md_googletest_docs_gmock_cook_book_DelegatingToFake}
...
With that, you can use {\ttfamily \mbox{\hyperlink{classMockFoo}{Mock\+Foo}}} in your tests as usual. Just remember that if you don\textquotesingle{}t explicitly set an action in an {\ttfamily ON\+\_\+\+CALL()} or {\ttfamily EXPECT\+\_\+\+CALL()}, the fake will be called upon to do it.\+:
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md129}{}\doxysection{Using Matchers}\label{md_googletest_docs_gmock_cook_book_autotoc_md129}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md130}{}\doxysubsection{Matching Argument Values Exactly}\label{md_googletest_docs_gmock_cook_book_autotoc_md130}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md131}{}\doxysubsection{Using Simple Matchers}\label{md_googletest_docs_gmock_cook_book_autotoc_md131}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_CombiningMatchers}{}\doxysubsection{Combining Matchers}\label{md_googletest_docs_gmock_cook_book_CombiningMatchers}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_SafeMatcherCast}{}\doxysubsection{Casting Matchers}\label{md_googletest_docs_gmock_cook_book_SafeMatcherCast}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_googletest_docs_gmock_cook_book_SelectOverload}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md_googletest_docs_gmock_cook_book_SelectOverload}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md132}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_googletest_docs_gmock_cook_book_autotoc_md132}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md133}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_googletest_docs_gmock_cook_book_autotoc_md133}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args$<$0, 1$>$(Truly(\&\+My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md134}{}\doxysubsection{Using Matchers as Predicates}\label{md_googletest_docs_gmock_cook_book_autotoc_md134}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md135}{}\doxysubsection{Using Matchers in googletest Assertions}\label{md_googletest_docs_gmock_cook_book_autotoc_md135}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md136}{}\doxysubsection{Using Predicates as Matchers}\label{md_googletest_docs_gmock_cook_book_autotoc_md136}
g\+Mock provides a set of built-\/in matchers for matching arguments with expected values—see the \mbox{\hyperlink{md_googletest_docs_reference_matchers}{Matchers Reference}} for more information. In case you find the built-\/in set lacking, you can use an arbitrary unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily Truly()} function, for example\+:
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in the statement {\ttfamily if (condition) ...}.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md137}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_googletest_docs_gmock_cook_book_autotoc_md137}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md138}{}\doxysubsection{Validating a Member of an Object}\label{md_googletest_docs_gmock_cook_book_autotoc_md138}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md139}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_googletest_docs_gmock_cook_book_autotoc_md139}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_googletest_docs_gmock_cook_book_CustomMatcherClass}{}\doxysubsection{Defining a Custom Matcher Class}\label{md_googletest_docs_gmock_cook_book_CustomMatcherClass}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md140}{}\doxysubsection{Matching Containers}\label{md_googletest_docs_gmock_cook_book_autotoc_md140}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md141}{}\doxysubsection{Sharing Matchers}\label{md_googletest_docs_gmock_cook_book_autotoc_md141}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_PureMatchers}{}\doxysubsection{Matchers must have no side-\/effects}\label{md_googletest_docs_gmock_cook_book_PureMatchers}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md142}{}\doxysection{Setting Expectations}\label{md_googletest_docs_gmock_cook_book_autotoc_md142}
\hypertarget{md_googletest_docs_gmock_cook_book_UseOnCall}{}\doxysubsection{Knowing When to Expect}\label{md_googletest_docs_gmock_cook_book_UseOnCall}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily EXPECT\+\_\+\+CALL()} statements will be an error.\hypertarget{md_googletest_docs_gmock_cook_book_uninteresting-vs-unexpected}{}\doxysubsection{Understanding Uninteresting vs Unexpected Calls}\label{md_googletest_docs_gmock_cook_book_uninteresting-vs-unexpected}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \href{\#NiceStrictNaggy}{\texttt{ \char`\"{}\+The Nice, the Strict, and the Naggy\char`\"{}}}.\hypertarget{md_googletest_docs_gmock_cook_book_ParameterlessExpectations}{}\doxysubsection{Ignoring Uninteresting Arguments}\label{md_googletest_docs_gmock_cook_book_ParameterlessExpectations}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md_googletest_docs_gmock_cook_book_PartialOrder}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md_googletest_docs_gmock_cook_book_PartialOrder}
...
If we view {\ttfamily EXPECT\+\_\+\+CALL()} statements as nodes in a graph, and add an edge from node A to node B wherever A must occur before B, we can get a DAG. We use the term \char`\"{}sequence\char`\"{} to mean a directed path in this DAG. Now, if we decompose the DAG into sequences, we just need to know which sequences each {\ttfamily EXPECT\+\_\+\+CALL()} belongs to in order to be able to reconstruct the original DAG.
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md145}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_googletest_docs_gmock_cook_book_autotoc_md145}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md146}{}\doxysection{Using Actions}\label{md_googletest_docs_gmock_cook_book_autotoc_md146}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md147}{}\doxysubsection{Returning References from Mock Methods}\label{md_googletest_docs_gmock_cook_book_autotoc_md147}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md148}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md_googletest_docs_gmock_cook_book_autotoc_md148}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md149}{}\doxysubsection{Combining Actions}\label{md_googletest_docs_gmock_cook_book_autotoc_md149}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_MockingSideEffects}{}\doxysubsection{Mocking Side Effects}\label{md_googletest_docs_gmock_cook_book_MockingSideEffects}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md150}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_googletest_docs_gmock_cook_book_autotoc_md150}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_googletest_docs_reference_mocking_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_googletest_docs_reference_mocking_DefaultValue}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md151}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_googletest_docs_gmock_cook_book_autotoc_md151}
...
Note that both {\ttfamily ON\+\_\+\+CALL} and {\ttfamily EXPECT\+\_\+\+CALL} have the same \char`\"{}later statements take precedence\char`\"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily EXPECT\+\_\+\+CALL}s have their own precedence order distinct from the {\ttfamily ON\+\_\+\+CALL} precedence order.\hypertarget{md_googletest_docs_gmock_cook_book_FunctionsAsActions}{}\doxysubsection{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}\label{md_googletest_docs_gmock_cook_book_FunctionsAsActions}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md152}{}\doxysubsection{Using Functions with Extra Info as Actions}\label{md_googletest_docs_gmock_cook_book_autotoc_md152}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md153}{}\doxysubsection{Invoking a Function/\+Method/\+Functor/\+Lambda/\+Callback Without Arguments}\label{md_googletest_docs_gmock_cook_book_autotoc_md153}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md154}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_googletest_docs_gmock_cook_book_autotoc_md154}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md155}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_googletest_docs_gmock_cook_book_autotoc_md155}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_googletest_docs_gmock_cook_book_SelectingArgs}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md_googletest_docs_gmock_cook_book_SelectingArgs}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md156}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_googletest_docs_gmock_cook_book_autotoc_md156}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md157}{}\doxysubsection{Sharing Actions}\label{md_googletest_docs_gmock_cook_book_autotoc_md157}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md158}{}\doxysubsection{Testing Asynchronous Behavior}\label{md_googletest_docs_gmock_cook_book_autotoc_md158}
One oft-\/encountered problem with g\+Mock is that it can be hard to test asynchronous behavior. Suppose you had a {\ttfamily Event\+Queue} class that you wanted to test, and you created a separate {\ttfamily Event\+Dispatcher} interface so that you could easily mock it out. However, the implementation of the class fired all the events on a background thread, which made test timings difficult. You could just insert {\ttfamily \mbox{\hyperlink{group__system_gab8c0d1f966b4e5110fd370b662d8c11b}{sleep()}}} statements and hope for the best, but that makes your test behavior nondeterministic. A better way is to use g\+Mock actions and {\ttfamily Notification} objects to force your asynchronous test to behave synchronously.
...
\{\+: .callout .note\} Note\+: this example has a downside\+: namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md159}{}\doxysection{Misc Recipes on Using g\+Mock}\label{md_googletest_docs_gmock_cook_book_autotoc_md159}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md160}{}\doxysubsection{Mocking Methods That Use Move-\/\+Only Types}\label{md_googletest_docs_gmock_cook_book_autotoc_md160}
...
A few actions (e.\+g. {\ttfamily Do\+All}) copy their arguments internally, so they can never work with non-\/copyable objects; you\textquotesingle{}ll have to use functors instead.\hypertarget{md_googletest_docs_gmock_cook_book_LegacyMoveOnly}{}\doxysubsubsection{Legacy workarounds for move-\/only types}\label{md_googletest_docs_gmock_cook_book_LegacyMoveOnly}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md161}{}\doxysubsection{Making the Compilation Faster}\label{md_googletest_docs_gmock_cook_book_autotoc_md161}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md162}{}\doxysubsection{Forcing a Verification}\label{md_googletest_docs_gmock_cook_book_autotoc_md162}
...
And that\textquotesingle{}s that.\hypertarget{md_googletest_docs_gmock_cook_book_UsingThreads}{}\doxysubsection{Using g\+Mock and Threads}\label{md_googletest_docs_gmock_cook_book_UsingThreads}
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md164}{}\doxysubsection{Controlling How Much Information g\+Mock Prints}\label{md_googletest_docs_gmock_cook_book_autotoc_md164}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md165}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md_googletest_docs_gmock_cook_book_autotoc_md165}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md166}{}\doxysubsection{Running Tests in Emacs}\label{md_googletest_docs_gmock_cook_book_autotoc_md166}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md167}{}\doxysection{Extending g\+Mock}\label{md_googletest_docs_gmock_cook_book_autotoc_md167}
\hypertarget{md_googletest_docs_gmock_cook_book_NewMatchers}{}\doxysubsection{Writing New Matchers Quickly}\label{md_googletest_docs_gmock_cook_book_NewMatchers}
...
\{\+: .callout .tip\} Tip\+: for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener$\ast$} instead of {\ttfamily std\+::ostream$\ast$}.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md170}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_googletest_docs_gmock_cook_book_autotoc_md170}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md171}{}\doxysubsection{Legacy Matcher Implementation}\label{md_googletest_docs_gmock_cook_book_autotoc_md171}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md172}{}\doxysubsection{Writing New Cardinalities}\label{md_googletest_docs_gmock_cook_book_autotoc_md172}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_QuickNewActions}{}\doxysubsection{Writing New Actions}\label{md_googletest_docs_gmock_cook_book_QuickNewActions}
...
Typically the {\ttfamily Once\+Action} and {\ttfamily Action} templates need not be referenced directly in your actions\+: a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily \mbox{\hyperlink{gmock-actions_8h_source}{gmock-\/actions.\+h}}} for examples.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md173}{}\doxysubsubsection{Legacy macro-\/based Actions}\label{md_googletest_docs_gmock_cook_book_autotoc_md173}
...
\end{longtabu}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md174}{}\doxysubsubsection{Legacy macro-\/based parameterized Actions}\label{md_googletest_docs_gmock_cook_book_autotoc_md174}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md175}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an ACTION}\label{md_googletest_docs_gmock_cook_book_autotoc_md175}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md176}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_googletest_docs_gmock_cook_book_autotoc_md176}
Sometimes you want to give an action explicit template parameters that cannot be inferred from its value parameters. {\ttfamily ACTION\+\_\+\+TEMPLATE()} supports that and can be viewed as an extension to {\ttfamily ACTION()} and {\ttfamily ACTION\+\_\+\+P$\ast$()}.
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md177}{}\doxysubsection{Using the ACTION Object\textquotesingle{}s Type}\label{md_googletest_docs_gmock_cook_book_autotoc_md177}
...
{\ttfamily ACTION\+\_\+\+P(\+Bar, param)}   &{\ttfamily Bar(int\+\_\+value)}   &{\ttfamily Bar\+ActionP$<$int$>$}    \\\cline{1-3}
...
{\ttfamily ACTION\+\_\+\+P2(\+Baz, p1, p2)}   &{\ttfamily Baz(bool\+\_\+value, int\+\_\+value)}   &{\ttfamily Baz\+Action\+P2$<$bool, int$>$}    \\\cline{1-3}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_googletest_docs_gmock_cook_book_NewMonoActions}{}\doxysubsection{Writing New Monomorphic Actions}\label{md_googletest_docs_gmock_cook_book_NewMonoActions}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_NewPolyActions}{}\doxysubsection{Writing New Polymorphic Actions}\label{md_googletest_docs_gmock_cook_book_NewPolyActions}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md178}{}\doxysubsection{Teaching g\+Mock How to Print Your Values}\label{md_googletest_docs_gmock_cook_book_autotoc_md178}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily $<$$<$} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{ The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md179}{}\doxysection{Useful Mocks Created Using g\+Mock}\label{md_googletest_docs_gmock_cook_book_autotoc_md179}
\hypertarget{md_googletest_docs_gmock_cook_book_MockFunction}{}\doxysubsection{Mock std\+::function}\label{md_googletest_docs_gmock_cook_book_MockFunction}

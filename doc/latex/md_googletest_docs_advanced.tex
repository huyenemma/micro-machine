\hypertarget{md_googletest_docs_advanced_autotoc_md12}{}\doxysection{Introduction}\label{md_googletest_docs_advanced_autotoc_md12}
Now that you have read the \mbox{\hyperlink{md_googletest_docs_primer}{Google\+Test Primer}} and learned how to write tests using Google\+Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_googletest_docs_advanced_autotoc_md13}{}\doxysection{More Assertions}\label{md_googletest_docs_advanced_autotoc_md13}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_googletest_docs_advanced_autotoc_md14}{}\doxysubsection{Explicit Success and Failure}\label{md_googletest_docs_advanced_autotoc_md14}
See \href{reference/assertions.md\#success-failure}{\texttt{ Explicit Success and Failure}} in the Assertions Reference.\hypertarget{md_googletest_docs_advanced_autotoc_md15}{}\doxysubsection{Exception Assertions}\label{md_googletest_docs_advanced_autotoc_md15}
See \href{reference/assertions.md\#exceptions}{\texttt{ Exception Assertions}} in the Assertions Reference.\hypertarget{md_googletest_docs_advanced_autotoc_md16}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_googletest_docs_advanced_autotoc_md16}
...
Google\+Test gives you three different options to solve this problem\+:\hypertarget{md_googletest_docs_advanced_autotoc_md17}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_googletest_docs_advanced_autotoc_md17}
If you already have a function or functor that returns {\ttfamily bool} (or a type that can be implicitly converted to {\ttfamily bool}), you can use it in a {\itshape predicate assertion} to get the function arguments printed for free. See \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily EXPECT\+\_\+\+PRED$\ast$}}} in the Assertions Reference for details.\hypertarget{md_googletest_docs_advanced_autotoc_md18}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_googletest_docs_advanced_autotoc_md18}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_advanced_autotoc_md19}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_googletest_docs_advanced_autotoc_md19}
If you find the default message generated by \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily EXPECT\+\_\+\+PRED$\ast$}}} and \href{reference/assertions.md\#EXPECT_TRUE}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE}}} unsatisfactory, or some arguments to your predicate do not support streaming to {\ttfamily ostream}, you can instead use {\itshape predicate-\/formatter assertions} to {\itshape fully} customize how the message is formatted. See \href{reference/assertions.md\#EXPECT_PRED_FORMAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+PRED\+\_\+\+FORMAT$\ast$}}} in the Assertions Reference for details.\hypertarget{md_googletest_docs_advanced_autotoc_md20}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_googletest_docs_advanced_autotoc_md20}
See \href{reference/assertions.md\#floating-point}{\texttt{ Floating-\/\+Point Comparison}} in the Assertions Reference.\hypertarget{md_googletest_docs_advanced_autotoc_md21}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_googletest_docs_advanced_autotoc_md21}
...
The above code verifies that {\ttfamily val1} is less than, or approximately equal to, {\ttfamily val2}.\hypertarget{md_googletest_docs_advanced_autotoc_md22}{}\doxysubsection{Asserting Using g\+Mock Matchers}\label{md_googletest_docs_advanced_autotoc_md22}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_googletest_docs_advanced_autotoc_md23}{}\doxysubsection{More String Assertions}\label{md_googletest_docs_advanced_autotoc_md23}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_advanced_autotoc_md24}{}\doxysubsection{Windows HRESULT assertions}\label{md_googletest_docs_advanced_autotoc_md24}
See \href{reference/assertions.md\#HRESULT}{\texttt{ Windows HRESULT Assertions}} in the Assertions Reference.\hypertarget{md_googletest_docs_advanced_autotoc_md25}{}\doxysubsection{Type Assertions}\label{md_googletest_docs_advanced_autotoc_md25}
...
to cause a compiler error.\hypertarget{md_googletest_docs_advanced_autotoc_md26}{}\doxysubsection{Assertion Placement}\label{md_googletest_docs_advanced_autotoc_md26}
...
{\ttfamily GTEST\+\_\+\+SKIP()} can be used in individual test cases or in the {\ttfamily Set\+Up()} methods of classes derived from either {\ttfamily \mbox{\hyperlink{classtesting_1_1Environment}{testing\+::\+Environment}}} or {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}}. For example\+:
...
As with assertion macros, you can stream a custom message into {\ttfamily GTEST\+\_\+\+SKIP()}.\hypertarget{md_googletest_docs_advanced_autotoc_md28}{}\doxysection{Teaching Google\+Test How to Print Your Values}\label{md_googletest_docs_advanced_autotoc_md28}
...
For more details regarding {\ttfamily Absl\+Stringify()} and its integration with other libraries, see go/abslstringify.\hypertarget{md_googletest_docs_advanced_autotoc_md29}{}\doxysection{Death Tests}\label{md_googletest_docs_advanced_autotoc_md29}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ \char`\"{}\+Catching\char`\"{} Failures}}.\hypertarget{md_googletest_docs_advanced_autotoc_md30}{}\doxysubsection{How to Write a Death Test}\label{md_googletest_docs_advanced_autotoc_md30}
...
In particular, if {\ttfamily statement} generates an {\ttfamily ASSERT\+\_\+$\ast$} or {\ttfamily EXPECT\+\_\+$\ast$} failure, it will {\bfseries{not}} cause the death test to fail, as Google\+Test assertions don\textquotesingle{}t abort the process.\hypertarget{md_googletest_docs_advanced_autotoc_md31}{}\doxysubsection{Death Test Naming}\label{md_googletest_docs_advanced_autotoc_md31}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_advanced_autotoc_md32}{}\doxysubsection{Regular Expression Syntax}\label{md_googletest_docs_advanced_autotoc_md32}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_googletest_docs_advanced_autotoc_md35}{}\doxysubsection{Death Test Styles}\label{md_googletest_docs_advanced_autotoc_md35}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_advanced_autotoc_md36}{}\doxysubsection{Caveats}\label{md_googletest_docs_advanced_autotoc_md36}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_googletest_docs_advanced_autotoc_md37}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_googletest_docs_advanced_autotoc_md37}
\{\+: .callout .note\} Note\+: If you want to put a series of test assertions in a subroutine to check for a complex condition, consider using \href{gmock_cook_book.md\#NewMatchers}{\texttt{ a custom GMock matcher}} instead. This lets you provide a more readable error message in case of failure and avoid all of the issues described below.\hypertarget{md_googletest_docs_advanced_autotoc_md38}{}\doxysubsection{Adding Traces to Assertions}\label{md_googletest_docs_advanced_autotoc_md38}
...
\end{DoxyEnumerate}\hypertarget{md_googletest_docs_advanced_autotoc_md39}{}\doxysubsection{Propagating Fatal Failures}\label{md_googletest_docs_advanced_autotoc_md39}
...
This listener should be added after other listeners if you have any, otherwise they won\textquotesingle{}t see failed {\ttfamily On\+Test\+Part\+Result}.\hypertarget{md_googletest_docs_advanced_autotoc_md41}{}\doxysubsubsection{Asserting on Subroutines}\label{md_googletest_docs_advanced_autotoc_md41}
...
Assertions from multiple threads are currently not supported on Windows.\hypertarget{md_googletest_docs_advanced_autotoc_md42}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_googletest_docs_advanced_autotoc_md42}
...
If {\ttfamily Has\+Fatal\+Failure()} is used outside of {\ttfamily TEST()} , {\ttfamily TEST\+\_\+\+F()} , or a test fixture, you must add the {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}\+:\+:} prefix, as in\+:
...
Similarly, {\ttfamily Has\+Nonfatal\+Failure()} returns {\ttfamily true} if the current test has at least one non-\/fatal failure, and {\ttfamily Has\+Failure()} returns {\ttfamily true} if the current test has at least one failure of either kind.\hypertarget{md_googletest_docs_advanced_autotoc_md43}{}\doxysection{Logging Additional Information}\label{md_googletest_docs_advanced_autotoc_md43}
...
\hypertarget{md_googletest_docs_advanced_autotoc_md44}{}\doxysection{Sharing Resources Between Tests in the Same Test Suite}\label{md_googletest_docs_advanced_autotoc_md44}
...
\{\+: .callout .note\} NOTE\+: Though the above code declares {\ttfamily Set\+Up\+Test\+Suite()} protected, it may sometimes be necessary to declare it public, such as when using it with {\ttfamily TEST\+\_\+P}.\hypertarget{md_googletest_docs_advanced_autotoc_md45}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_googletest_docs_advanced_autotoc_md45}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs_advanced_autotoc_md47}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_googletest_docs_advanced_autotoc_md47}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+SUITE\+\_\+\+P()}, and depending on the library target that contains {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test suite multiple times, possibly in different source files.\hypertarget{md_googletest_docs_advanced_autotoc_md49}{}\doxysubsection{Specifying Names for Value-\/\+Parameterized Test Parameters}\label{md_googletest_docs_advanced_autotoc_md49}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_advanced_autotoc_md50}{}\doxysection{Typed Tests}\label{md_googletest_docs_advanced_autotoc_md50}
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_googletest_docs_advanced_autotoc_md51}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_googletest_docs_advanced_autotoc_md51}
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_googletest_docs_advanced_autotoc_md52}{}\doxysection{Testing Private Code}\label{md_googletest_docs_advanced_autotoc_md52}
...
\item Private class members are only accessible from within the class or by friends. To access a class\textquotesingle{} private members, you can declare your test fixture as a friend to the class and define accessors in your fixture. \mbox{\hyperlink{structTests}{Tests}} using the fixture can then access the private members of your production class via the accessors in the fixture. Note that even though your fixture is a friend to your production class, your tests are not automatically friends to it, as they are technically defined in sub-\/classes of the fixture.
...
\`{}\`{}\`{}c++ FRIEND\+\_\+\+TEST(\+Test\+Suite\+Name, Test\+Name); \`{}\`{}\`{}
...
class Foo \{ friend class \mbox{\hyperlink{classFooTest}{Foo\+Test}}; FRIEND\+\_\+\+TEST(\+Foo\+Test, Bar); FRIEND\+\_\+\+TEST(\+Foo\+Test, Baz); ... definition of the class Foo ... \};
...
\} // namespace my\+\_\+namespace \`{}\`{}\`{}
\end{DoxyItemize}\hypertarget{md_googletest_docs_advanced_autotoc_md53}{}\doxysection{\char`\"{}\+Catching\char`\"{} Failures}\label{md_googletest_docs_advanced_autotoc_md53}
...
\end{DoxyEnumerate}\hypertarget{md_googletest_docs_advanced_autotoc_md54}{}\doxysection{Registering tests programmatically}\label{md_googletest_docs_advanced_autotoc_md54}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_advanced_autotoc_md55}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_googletest_docs_advanced_autotoc_md55}
...
{\ttfamily current\+\_\+test\+\_\+info()} returns a null pointer if no test is running. In particular, you cannot find the test suite name in {\ttfamily Set\+Up\+Test\+Suite()}, {\ttfamily Tear\+Down\+Test\+Suite()} (where you know the test suite name implicitly), or functions called from them.\hypertarget{md_googletest_docs_advanced_autotoc_md56}{}\doxysection{Extending Google\+Test by Handling Test Events}\label{md_googletest_docs_advanced_autotoc_md56}
Google\+Test provides an {\bfseries{event listener API}} to let you receive notifications about the progress of a test program and test failures. The events you can listen to include the start and end of the test program, a test suite, or a test method, among others. You may use this API to augment or replace the standard console output, replace the XML output, or provide a completely different form of output, such as a GUI or a database. You can also use test events as checkpoints to implement a resource leak checker, for example.\hypertarget{md_googletest_docs_advanced_autotoc_md57}{}\doxysubsection{Defining Event Listeners}\label{md_googletest_docs_advanced_autotoc_md57}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_advanced_autotoc_md58}{}\doxysubsection{Using Event Listeners}\label{md_googletest_docs_advanced_autotoc_md58}
To use the event listener you have defined, add an instance of it to the Google\+Test event listener list (represented by class \href{reference/testing.md\#TestEventListeners}{\texttt{ {\ttfamily Test\+Event\+Listeners}}} -\/ note the \char`\"{}s\char`\"{} at the end of the name) in your {\ttfamily main()} function, before calling {\ttfamily RUN\+\_\+\+ALL\+\_\+\+TESTS()}\+:
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default XML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_googletest_docs_advanced_autotoc_md59}{}\doxysubsection{Generating Failures in Listeners}\label{md_googletest_docs_advanced_autotoc_md59}
You may use failure-\/raising macros ({\ttfamily EXPECT\+\_\+$\ast$()}, {\ttfamily ASSERT\+\_\+$\ast$()}, {\ttfamily FAIL()}, etc) when processing an event. There are some restrictions\+:
...
If an option is specified both by an environment variable and by a flag, the latter takes precedence.\hypertarget{md_googletest_docs_advanced_autotoc_md61}{}\doxysubsection{Selecting Tests}\label{md_googletest_docs_advanced_autotoc_md61}
\hypertarget{md_googletest_docs_advanced_autotoc_md62}{}\doxysubsubsection{Listing Test Names}\label{md_googletest_docs_advanced_autotoc_md62}
...
None of the tests listed are actually run if the flag is provided. There is no corresponding environment variable for this flag.\hypertarget{md_googletest_docs_advanced_autotoc_md63}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_googletest_docs_advanced_autotoc_md63}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md64}{}\doxysubsubsection{Stop test execution upon first failure}\label{md_googletest_docs_advanced_autotoc_md64}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md65}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_googletest_docs_advanced_autotoc_md65}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md66}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_googletest_docs_advanced_autotoc_md66}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md67}{}\doxysubsection{Repeating the Tests}\label{md_googletest_docs_advanced_autotoc_md67}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md68}{}\doxysubsection{Shuffling the Tests}\label{md_googletest_docs_advanced_autotoc_md68}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md69}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_googletest_docs_advanced_autotoc_md69}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md70}{}\doxysubsection{Controlling Test Output}\label{md_googletest_docs_advanced_autotoc_md70}
{\itshape  }\hypertarget{md_googletest_docs_advanced_autotoc_md71}{}\doxysubsubsection{Colored Terminal Output}\label{md_googletest_docs_advanced_autotoc_md71}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md72}{}\doxysubsubsection{Suppressing test passes}\label{md_googletest_docs_advanced_autotoc_md72}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md73}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_googletest_docs_advanced_autotoc_md73}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md74}{}\doxysubsubsection{Suppressing UTF-\/8 Text Output}\label{md_googletest_docs_advanced_autotoc_md74}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md75}{}\doxysubsubsection{Generating an XML Report}\label{md_googletest_docs_advanced_autotoc_md75}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md76}{}\doxysubsubsection{Generating a JSON Report}\label{md_googletest_docs_advanced_autotoc_md76}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md77}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_googletest_docs_advanced_autotoc_md77}
{\itshape  }\hypertarget{md_googletest_docs_advanced_autotoc_md78}{}\doxysubsubsection{Detecting Test Premature Exit}\label{md_googletest_docs_advanced_autotoc_md78}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md79}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_googletest_docs_advanced_autotoc_md79}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md80}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_googletest_docs_advanced_autotoc_md80}
...
{\itshape }\hypertarget{md_googletest_docs_advanced_autotoc_md81}{}\doxysubsection{Sanitizer Integration}\label{md_googletest_docs_advanced_autotoc_md81}

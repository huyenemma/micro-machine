...
\{\+: .callout .warning\} {\bfseries{WARNING\+:}} Equality matching via {\ttfamily EXPECT\+\_\+\+THAT(actual\+\_\+value, expected\+\_\+value)} is supported, however note that implicit conversions can cause surprising results. For example, {\ttfamily EXPECT\+\_\+\+THAT(some\+\_\+bool, \char`\"{}some string\char`\"{})} will compile and may pass unintentionally.
...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily \+::testing} namespace unless otherwise noted.\hypertarget{md_googletest_docs_reference_matchers_autotoc_md249}{}\doxysection{Wildcard}\label{md_googletest_docs_reference_matchers_autotoc_md249}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_matchers_autotoc_md250}{}\doxysection{Generic Comparison}\label{md_googletest_docs_reference_matchers_autotoc_md250}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{assertions.md\#boolean}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE} and {\ttfamily EXPECT\+\_\+\+FALSE}}} assertions.\hypertarget{md_googletest_docs_reference_matchers_FpMatchers}{}\doxysection{Floating-\/\+Point Matchers}\label{md_googletest_docs_reference_matchers_FpMatchers}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_matchers_autotoc_md251}{}\doxysection{String Matchers}\label{md_googletest_docs_reference_matchers_autotoc_md251}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_googletest_docs_reference_matchers_autotoc_md252}{}\doxysection{Container Matchers}\label{md_googletest_docs_reference_matchers_autotoc_md252}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs_reference_matchers_autotoc_md253}{}\doxysection{Member Matchers}\label{md_googletest_docs_reference_matchers_autotoc_md253}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs_reference_matchers_autotoc_md254}{}\doxysection{Matching the Result of a Function, Functor, or Callback}\label{md_googletest_docs_reference_matchers_autotoc_md254}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_matchers_autotoc_md255}{}\doxysection{Pointer Matchers}\label{md_googletest_docs_reference_matchers_autotoc_md255}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_matchers_MultiArgMatchers}{}\doxysection{Multi-\/argument Matchers}\label{md_googletest_docs_reference_matchers_MultiArgMatchers}
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_matchers_autotoc_md256}{}\doxysection{Composite Matchers}\label{md_googletest_docs_reference_matchers_autotoc_md256}
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_matchers_autotoc_md257}{}\doxysection{Adapters for Matchers}\label{md_googletest_docs_reference_matchers_autotoc_md257}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md_googletest_docs_reference_matchers_MatchersAsPredicatesCheat}{}\doxysection{Using Matchers as Predicates}\label{md_googletest_docs_reference_matchers_MatchersAsPredicatesCheat}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_matchers_autotoc_md258}{}\doxysection{Defining Matchers}\label{md_googletest_docs_reference_matchers_autotoc_md258}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}

This tutorial aims to get you up and running with Google\+Test using the Bazel build system. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point.\hypertarget{md_googletest_docs_quickstart_bazel_autotoc_md231}{}\doxysection{Prerequisites}\label{md_googletest_docs_quickstart_bazel_autotoc_md231}
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_googletest_docs_quickstart_bazel_autotoc_md232}{}\doxysection{Set up a Bazel workspace}\label{md_googletest_docs_quickstart_bazel_autotoc_md232}
...
Now you\textquotesingle{}re ready to build C++ code that uses Google\+Test.\hypertarget{md_googletest_docs_quickstart_bazel_autotoc_md233}{}\doxysection{Create and run a binary}\label{md_googletest_docs_quickstart_bazel_autotoc_md233}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_googletest_docs_quickstart_bazel_autotoc_md234}{}\doxysection{Next steps}\label{md_googletest_docs_quickstart_bazel_autotoc_md234}

...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily samples/sample3\+\_\+unittest.\+cc}.\hypertarget{md_googletest_docs_pkgconfig_autotoc_md217}{}\doxysubsection{CMake}\label{md_googletest_docs_pkgconfig_autotoc_md217}
...
pkg-\/config will also try to look in {\ttfamily PKG\+\_\+\+CONFIG\+\_\+\+PATH} to find {\ttfamily gtest\+\_\+main.\+pc}.\hypertarget{md_googletest_docs_pkgconfig_autotoc_md219}{}\doxysubsection{Using pkg-\/config in a cross-\/compilation setting}\label{md_googletest_docs_pkgconfig_autotoc_md219}

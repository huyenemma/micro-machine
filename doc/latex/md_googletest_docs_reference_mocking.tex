This page lists the facilities provided by Google\+Test for creating and working with mock objects. To use them, add {\ttfamily \#include $<$\mbox{\hyperlink{gmock_8h_source}{gmock/gmock.\+h}}$>$}.\hypertarget{md_googletest_docs_reference_mocking_macros}{}\doxysection{Macros}\label{md_googletest_docs_reference_mocking_macros}
Google\+Test defines the following macros for working with mocks.\hypertarget{md_googletest_docs_reference_mocking_MOCK_METHOD}{}\doxysubsection{MOCK\+\_\+\+METHOD}\label{md_googletest_docs_reference_mocking_MOCK_METHOD}
...
See details for each modifier clause below.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md260}{}\doxysubsubsection{With \{\#\+EXPECT\+\_\+\+CALL.\+With\}}\label{md_googletest_docs_reference_mocking_autotoc_md260}
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md261}{}\doxysubsubsection{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}\label{md_googletest_docs_reference_mocking_autotoc_md261}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md262}{}\doxysubsubsection{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}\label{md_googletest_docs_reference_mocking_autotoc_md262}
...
See also the \href{\#InSequence}{\texttt{ {\ttfamily In\+Sequence} class}}.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md263}{}\doxysubsubsection{After \{\#\+EXPECT\+\_\+\+CALL.\+After\}}\label{md_googletest_docs_reference_mocking_autotoc_md263}
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md264}{}\doxysubsubsection{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}\label{md_googletest_docs_reference_mocking_autotoc_md264}
...
The parameter $\ast${\ttfamily action}$\ast$ represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ action}} that the function call will perform. See the \mbox{\hyperlink{md_googletest_docs_reference_actions}{Actions Reference}} for a list of built-\/in actions.
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md265}{}\doxysubsubsection{Will\+Repeatedly \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}\label{md_googletest_docs_reference_mocking_autotoc_md265}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md266}{}\doxysubsubsection{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}\label{md_googletest_docs_reference_mocking_autotoc_md266}
...
The {\ttfamily Retires\+On\+Saturation} clause can be used at most once on an expectation and must be the last clause.\hypertarget{md_googletest_docs_reference_mocking_ON_CALL}{}\doxysubsection{ON\+\_\+\+CALL}\label{md_googletest_docs_reference_mocking_ON_CALL}
...
The parameter $\ast${\ttfamily matchers...}$\ast$ is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{ matchers}} that correspond to each argument of the method $\ast${\ttfamily method\+\_\+name}$\ast$. The {\ttfamily ON\+\_\+\+CALL} specification will apply only to calls of $\ast${\ttfamily method\+\_\+name}$\ast$ whose arguments match all of the matchers. If {\ttfamily (}$\ast${\ttfamily matchers...}$\ast${\ttfamily )} is omitted, the behavior is as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{ wildcard matcher ({\ttfamily \+\_\+})}}. See the \mbox{\hyperlink{md_googletest_docs_reference_matchers}{Matchers Reference}} for a list of all built-\/in matchers.
...
See details for each modifier clause below.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md267}{}\doxysubsubsection{With \{\#\+ON\+\_\+\+CALL.\+With\}}\label{md_googletest_docs_reference_mocking_autotoc_md267}
{\ttfamily .With(}$\ast${\ttfamily multi\+\_\+argument\+\_\+matcher}$\ast${\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md268}{}\doxysubsubsection{Will\+By\+Default \{\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}\label{md_googletest_docs_reference_mocking_autotoc_md268}
...
The {\ttfamily Will\+By\+Default} clause must be used exactly once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_googletest_docs_reference_mocking_classes}{}\doxysection{Classes}\label{md_googletest_docs_reference_mocking_classes}
Google\+Test defines the following classes for working with mocks.\hypertarget{md_googletest_docs_reference_mocking_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_googletest_docs_reference_mocking_DefaultValue}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_reference_mocking_NiceMock}{}\doxysubsection{Nice\+Mock}\label{md_googletest_docs_reference_mocking_NiceMock}
...
{\ttfamily Nice\+Mock$<$T$>$} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_googletest_docs_reference_mocking_NaggyMock}{}\doxysubsection{Naggy\+Mock}\label{md_googletest_docs_reference_mocking_NaggyMock}
...
\mbox{\hyperlink{classMock}{Mock}} objects of type {\ttfamily T} by default behave the same way as {\ttfamily Naggy\+Mock$<$T$>$}.\hypertarget{md_googletest_docs_reference_mocking_StrictMock}{}\doxysubsection{Strict\+Mock}\label{md_googletest_docs_reference_mocking_StrictMock}
...
{\ttfamily Strict\+Mock$<$T$>$} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_googletest_docs_reference_mocking_Sequence}{}\doxysubsection{Sequence}\label{md_googletest_docs_reference_mocking_Sequence}
{\ttfamily \+::testing\+::\+Sequence}

Represents a chronological sequence of expectations. See the \href{\#EXPECT_CALL.InSequence}{\texttt{ {\ttfamily In\+Sequence}}} clause of {\ttfamily EXPECT\+\_\+\+CALL} for usage.\hypertarget{md_googletest_docs_reference_mocking_InSequence}{}\doxysubsection{In\+Sequence}\label{md_googletest_docs_reference_mocking_InSequence}
...
The name of the {\ttfamily In\+Sequence} object does not matter.\hypertarget{md_googletest_docs_reference_mocking_Expectation}{}\doxysubsection{Expectation}\label{md_googletest_docs_reference_mocking_Expectation}
...
Useful for specifying sequences of expectations; see the \href{\#EXPECT_CALL.After}{\texttt{ {\ttfamily After}}} clause of {\ttfamily EXPECT\+\_\+\+CALL}.\hypertarget{md_googletest_docs_reference_mocking_ExpectationSet}{}\doxysubsection{Expectation\+Set}\label{md_googletest_docs_reference_mocking_ExpectationSet}

 ...
 * @details Inherits from sf::Drawable and provides functionality for handling collectables.
 */
...
public:
     ...
     * @return A pair representing the x and y coordinates of the collectable's position.
     */
...
private:
    ...
    bool toBeDeleted = false; ///< Flag indicating whether the collectable should be deleted.
